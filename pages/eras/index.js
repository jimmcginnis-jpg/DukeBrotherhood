...
export default function ErasIndex() {
  return (
    <Layout
      title="All Eras"
      description="Browse Duke basketball history by era — from Coach K's Foundation to the Scheyer Era."
      canonical="/eras/"
    >
      <section className="bg-duke-slate text-white py-12">
        <div className="max-w-5xl mx-auto px-4">
          <h1 className="font-display text-4xl font-bold mb-4">Eras of Duke Basketball</h1>
          <p className="font-body text-duke-goldLight text-lg">
            Eight chapters, four decades, one Brotherhood.
          </p>
        </div>
      </section>
          ...
          {data.eras.map(era => {
            ...
            return (
              ...
              >
                ...
                <h2 className="font-display text-2xl text-duke-navy mb-2">{era.name}</h2>
